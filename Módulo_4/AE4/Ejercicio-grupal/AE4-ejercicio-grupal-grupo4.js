...
const realizarPedidoBonus = () => {
  ...
  Promise.allSettled(preparaciones).then((resultados) => {
    // el método all Settled itera sobre ese array de promesas y devuelve un array de objetos con los resultados de cada promesa, sin importar si se cumplen o no, y sin cortar el flujo en caso de fallo

    const nombres = ["Café", "Pan", "Jugo"];

    resultados.forEach((resultado, i) => {
      // Dentro del.then, formateamos para dar legibilidad al resultado en consola. Por cada promesa "fulfilled" se imprime un mensaje de "listo" y el tiempo de preparación. Por cada promesa "rejected" se imprime un mensaje de "fallo" y la razón del error
